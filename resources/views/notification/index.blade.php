    ...
    <div class="page">
        <div class="timelines">
            <div class="timeline__group">
                <span class="timeline__year time" aria-hidden="true">Belum dibaca</span>
                <div class="timeline__cards">
                    ...
                    <div class="timeline__card card">
                        <div class="card__content">
                            <p>Tidak ada notifikasi baru yang belum dibaca</p>
                        </div>
                    </div>
                    @endforelse
                </div>
            ...
            <div class="timeline__group">
                <span class="timeline__year time" aria-hidden="true">Baca</span>
                <div class="timeline__cards">
